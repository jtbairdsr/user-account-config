...
Plug 'yegappan/greplace'                                 " plugin to search and replace a pattern across multiple files interactively
" }}} End General
...
" -- Conquer of Completion --- {{{ - bundle name: neoclide/coc.nvim --------------------------------------------
...
" inoremap <silent><expr> <c-space> coc#refresh() TODO: I need to figure out a better keymap for this so that I don't
" compete with fzf
